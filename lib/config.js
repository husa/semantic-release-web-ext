...
export const getConfig = (pluginConfig, context) => {
  return {
    ...
    approvalTimeout:
      pluginConfig.approvalTimeout || tryToNumber(context.env.WEB_EXT_APPROVAL_TIMEOUT) || 0,
    validationTimeout:
      pluginConfig.validationTimeout || tryToNumber(context.env.WEB_EXT_VALIDATION_TIMEOUT) || 0,
    amoBaseUrl:
